...
/// <summary>
/// Атрибут свойства модели, указывает на необходимость удостовериться, что 
/// текст свойства содержит только латинские символы
/// </summary>
public class AriphmeticChartsAttribute : Attribute, MyValidation
{
    /// <summary>
    ...
    public AriphmeticChartsAttribute( string message="" )
    {
        _message = message;
    }
