...
/// текст свойства содержит только знаки пунктуации
/// </summary>
public class PunctuationCharsAttribute : Attribute, MyValidation
{
    /// <summary>
    ...
    public PunctuationCharsAttribute( string message="" )
    {
        _message = message;
    }
