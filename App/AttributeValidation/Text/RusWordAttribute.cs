...
public class RusWordAttribute : InputTextAttribute, MyValidation
{

    private readonly string _message;

    public RusWordAttribute(string message = "Значение может содержать только буквы русского алфавита")
    {
        _message = message;
    }
